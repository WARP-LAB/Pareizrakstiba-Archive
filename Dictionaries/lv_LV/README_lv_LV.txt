...
# lietoðanai ar LibreOffice un OpenOffice u.c.
# Latvian spelling dictionary (affix and dictionary files) for Libre-/OpenOffice
#
# Copyright (C) 2002-2013 Janis Eisaks, jancs@dv.lv, http://dict.dv.lv
# 
...
Version info 0.9.6
Svarîgs paziòojums: 
ðî ir vispçdçjâkâ vârdnîcas versija, kas ir 100% MySpell savietojama. 
